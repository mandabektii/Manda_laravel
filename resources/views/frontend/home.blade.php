    ...
    <section id="clients" class="clients section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <img src="{{ asset('frontend/assets/img/clients/client-3.png') }}" class="img-fluid" alt="">
          ...
          <div class="col-xl-3 col-md-4 client-logo">
            <img src="{{ asset('frontend/assets/img/clients/client-6.png" class="img-fluid') }}" class="img-fluid" alt="">
          </div><!-- End Client Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ asset('frontend/assets/img/gallery/gallery-1.jpg') }}" class="glightbox" data-gallery="images-gallery">
                <img src="{{ asset('frontend/assets/img/gallery/gallery-1.jp') }}g" alt="" class="img-fluid">
              </a>
            </div>
